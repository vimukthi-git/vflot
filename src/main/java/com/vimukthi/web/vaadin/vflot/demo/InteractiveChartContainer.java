 ...
 *
 */
public class InteractiveChartContainer extends GridLayout {

	/**
	 * @param columns
	 * @param rows
	 */
	public InteractiveChartContainer() {
		super(2, 2);		
		setSizeFull();
		setSpacing(true);
		...
		titlebar1.addComponent(new Label("Click and Hover"));		
		...
		titlebar2.addComponent(new Label("Selection"));		
		...
		titlebar3.addComponent(new Label("Navigate"));		
		...
		titlebar4.addComponent(new Label("Tracking"));		
